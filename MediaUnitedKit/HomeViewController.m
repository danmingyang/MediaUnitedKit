...
- (void)viewDidLoad
{
    ...
    CGFloat margin = 10.f;
    // 按钮宽高
    CGFloat itemWidth = kScreenWidth - 2 * margin;
    ...
    switch (index)
    {
        ...
        case 3: // 音频采集播放
        {
            ...
            [controller setMp3FileNameBlock:^(NSString *mp3FileName) {
                AudioPlayViewController * audioController = [[AudioPlayViewController alloc] init];
                audioController.mp3FileName = mp3FileName;
